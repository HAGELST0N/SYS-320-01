...
echo -n "Please Input a Building Abreviation and Room Number: "
read location
...
cat "$courseFile" | grep "$code" >> classes.txt
awk "NR > 1" classes.txt >> classes2.txt
awk -F'; "$4 > 0 {print $1, $2}" classes2.txt 
